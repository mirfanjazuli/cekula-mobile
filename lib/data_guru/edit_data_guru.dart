...
import 'package:cekula/data_guru/data_guru1.dart';
...
class EditDataGuru extends StatelessWidget {
  const EditDataGuru({Key? key}) : super(key: key);
                            ...
                            child: Center(
                              child: Padding(
                                padding: const EdgeInsets.only(
                                    left: 10.0, bottom: 8),
                                child: TextFormField(
                                  initialValue: 'S1 Pendidikan IPA',
                                  decoration: InputDecoration(
                                      border: InputBorder.none,
                                      // hintText:
