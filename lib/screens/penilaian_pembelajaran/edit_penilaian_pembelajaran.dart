...
class _EditPenilaianPembelajaranState extends State<EditPenilaianPembelajaran> {
  final List nama = [
    "Ahmad Jourji Zaidan",
                  ...
                  children: [
                    Container(
                      ...
                      padding: EdgeInsets.only(
                        top:
                            bodyHeight * (0.03125 + 0.0125 + 0.01875) + 24 + 16,
                      ),
                      child: ListView(
                        children: [
                          Container(
                            height: bodyHeight -
                                (bodyHeight * 0.10625) -
                                87 -
                                (bodyHeight * (0.03125 + 0.0125 + 0.01875) +
                                    24 +
                                    16),
                            color: Colors.white,
