...
import 'package:cekula/screens/penerimaan_murid_baru/penerimaan_murid2.dart';
import 'package:cekula/screens/radio/radio_jenis_kelamin.dart';

class PenerimaanMuridBaru1 extends StatelessWidget {
  const PenerimaanMuridBaru1({Key? key}) : super(key: key);
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                decoration: InputDecoration(
                                    border: InputBorder.none,
                                    hintText: 'Masukkan tempat lahir murid',
                                    hintStyle: GoogleFonts.notoSans(
                                        color: const Color(0xFFA6AAB4))),
                                style: GoogleFonts.notoSans(
                                    fontSize: 12, fontWeight: FontWeight.w400),
                            ...
                            child: Center(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    hintText: 'Masukkan tanggal lahir murid',
                                    hintStyle: GoogleFonts.notoSans(
                                        color: const Color(0xFFA6AAB4)),
                                    suffixIcon: Padding(
