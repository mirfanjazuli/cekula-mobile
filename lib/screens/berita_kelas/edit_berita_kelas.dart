...
class _EditBeritaKelasState extends State<EditBeritaKelas> {
  ...
  bool formJudulBerita = false;
  // bool formTanggalMulai = false;
  // bool formTanggalSelesai = false;
  bool formDeskripsiBerita = false;

  TextEditingController _controllerJudulBerita = TextEditingController();
  ...
  TextEditingController _controllerDeskripsiBerita = TextEditingController();
  ...
  void initState() {
    super.initState();
    _controllerJudulBerita = TextEditingController();
    _controllerJudulBerita.addListener(() {
      final formJudulBerita = _controllerJudulBerita.text.isNotEmpty;
      setState(() => this.formJudulBerita = formJudulBerita);
    });
    ...
    _controllerDeskripsiBerita = TextEditingController();
    _controllerDeskripsiBerita.addListener(() {
      final formDeskripsiBerita = _controllerDeskripsiBerita.text.isNotEmpty;
      setState(() => this.formDeskripsiBerita = formDeskripsiBerita);
    });

    _controllerJudulBerita.text = "Kegiatan Tengah Semester";
    // _controllerTanggalMulai.text = "15/09/22";
    // _controllerTanggalSelesai.text = "18/09/22";

    _controllerDeskripsiBerita.text =
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: Center(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  controller: _controllerJudulBerita,
                                  onChanged:
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                controller: _controllerDeskripsiBerita,
