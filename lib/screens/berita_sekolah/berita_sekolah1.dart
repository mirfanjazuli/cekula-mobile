...
import 'package:cekula/screens/berita_sekolah/buat_berita_sekolah.dart';
import 'package:cekula/screens/berita_sekolah/edit_berita_sekolah.dart';
import 'package:cekula/screens/berita_sekolah/view_berita_sekolah.dart';
import 'package:cekula/screens/drawer/drawer.dart';

class BeritaSekolah1 extends StatefulWidget {
  const BeritaSekolah1({Key? key}) : super(key: key);

  @override
  State<BeritaSekolah1> createState() => _BeritaSekolah1State();
}

class _BeritaSekolah1State extends State<BeritaSekolah1> {
  final List image = [
