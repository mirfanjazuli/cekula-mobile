...
class BuatMonitoringOsis extends StatefulWidget {
  const BuatMonitoringOsis({Key? key}) : super(key: key);

  @override
  State<BuatMonitoringOsis> createState() => _BuatMonitoringOsisState();
}

class _BuatMonitoringOsisState extends State<BuatMonitoringOsis> {
