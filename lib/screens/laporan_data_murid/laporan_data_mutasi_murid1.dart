...
class LaporanDataMutasiMurid1 extends StatelessWidget {
  final List tahun = [
    "2019/2020",
    "2020/2021",
    "2021/2022",
                                ...
                                children: [
                                  ...
                                  Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          Text(
                                              "Laporan Mutasi Murid Tahun Ajaran ${tahun[index]}",
                                              style: GoogleFonts.notoSans(
                                                  fontSize: 12,
                                                  fontWeight: FontWeight.w600,
                                                  color: Color(0xFF4D5569))),
                                          Text(
                                              "Hasil Mutasi Laporan Murid Baru Tahun Ajaran ${tahun[index]}",
                                              style: GoogleFonts.notoSans(
                                                  fontSize: 10,
                                                  fontWeight: FontWeight.w600,
