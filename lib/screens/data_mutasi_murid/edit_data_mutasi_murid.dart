...
class EditDataMutasiMurid extends StatelessWidget {
  const EditDataMutasiMurid({Key? key}) : super(key: key);
                          ...
                          Container(
                            ...
                            child: Center(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  initialValue:
                                      'Jl. Seruji No.8, Gurah, Kediri, Jawa Timur',
                                  decoration: InputDecoration(
                                      border: InputBorder.none,
                                      // hintText:
