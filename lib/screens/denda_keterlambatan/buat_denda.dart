...
import 'package:cekula/screens/radio/radio_denda_buku.dart';
...
class BuatDenda extends StatelessWidget {
  const BuatDenda({Key? key}) : super(key: key);
                            ...
                            child: Center(
                              child: Padding(
                                ...
                                child: TextFormField(
                                  // initialValue: "15/09/2022",
                                  decoration: InputDecoration(
                                    hintText: 'Pilih tenggat peminjaman',
                                    hintStyle: GoogleFonts.notoSans(
                                        color: const Color(0xFFA6AAB4)),
                                    suffixIcon: Padding(
                                      padding: const EdgeInsets.only(
