...
import 'package:cekula/screens/data_murid/edit_data_murid4.dart';
import 'package:cekula/screens/drawer/drawer.dart';
import 'package:cekula/screens/jadwal_kelas/jadwal_kelas2.dart';

class EditDataMurid3 extends StatelessWidget {
  const EditDataMurid3({Key? key}) : super(key: key);
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                decoration: InputDecoration(
                                    ...
                                    hintText: 'Masukkan nama orang tua murid',
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                decoration: InputDecoration(
                                    border: InputBorder.none,
                                    hintText: 'Masukkan pekerjaan orang tua',
                                    hintStyle: GoogleFonts.notoSans(
                                        color: const Color(0xFFA6AAB4))),
                                style: GoogleFonts.notoSans(
                                    fontSize: 12, fontWeight: FontWeight.w400),
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                decoration: InputDecoration(
                                    border: InputBorder.none,
                                    hintText:
                                        'Masukkan nomor telepon orang tua',
                                    hintStyle: GoogleFonts.notoSans(
                                        color: const Color(0xFFA6AAB4))),
                                style: GoogleFonts.notoSans(
                                    fontSize: 12, fontWeight: FontWeight.w400),
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                decoration: InputDecoration(
                                    border: InputBorder.none,
                                    hintText: 'Masukkan nomor telepon wali',
                                    hintStyle: GoogleFonts.notoSans(
                                        color: const Color(0xFFA6AAB4))),
                                style: GoogleFonts.notoSans(
                                    fontSize: 12, fontWeight: FontWeight.w400),
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                decoration: InputDecoration(
                                    border: InputBorder.none,
                                    hintText: 'Masukkan nomor telepon siswa',
                                    hintStyle: GoogleFonts.notoSans(
                                        color: const Color(0xFFA6AAB4))),
                                style: GoogleFonts.notoSans(
                                    fontSize: 12, fontWeight: FontWeight.w400),
