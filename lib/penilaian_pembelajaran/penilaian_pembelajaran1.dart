...
class PenilaianPembelajaran1 extends StatefulWidget {
  const PenilaianPembelajaran1({Key? key}) : super(key: key);

  @override
  State<PenilaianPembelajaran1> createState() => _PenilaianPembelajaran1State();
}

class _PenilaianPembelajaran1State extends State<PenilaianPembelajaran1> {
  int aktif = 0;
