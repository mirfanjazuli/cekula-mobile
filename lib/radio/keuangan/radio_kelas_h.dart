...
class RadioKeuanganKelasH extends StatefulWidget {
  const RadioKeuanganKelasH({Key? key}) : super(key: key);
...
class CustomRadioState extends State<RadioKeuanganKelasH> {
